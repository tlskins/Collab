  ...
  def create
    ...
    if resource.persisted?
      if resource.active_for_authentication?
        ...
        collab_project = CollabProject.find_by(id: params[:collab_id])
        if invite and collab_project
          invite.destroy
          collab_project.collaborators.create(admin_id: resource.id, collab_id: params[:collab_id])
