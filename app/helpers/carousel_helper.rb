module CarouselHelper
  ...
  class Carousel
    ...
    def slide_tag(image, is_active)
      options = {
        class: (is_active ? 'item active col-md-offset-4' : 'item col-md-offset-4'),
      }

      content_tag(:div, safe_join([ image_tag(image, class: 'd-block img-fluid'), content_tag(:div, content_tag(:h3, 'caption'), class: 'carousel-caption d-none d-md-block')] ), options)
    end
